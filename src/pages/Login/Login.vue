        ...
        <form @submit.prevent="login">
          <div :class="{on: loginWay}">
            ...
            <section class="login_hint">
              温馨提示：未注册懒人外卖帐号的手机号，登录时将自动注册，且代表已同意
          ...
          <div :class="{on: !loginWay}">
            <section>
              ...
              <section class="login_verification">
                ...
                <div class="switch_button" :class="showPwd ? 'on' : 'off'" @click.prevent="showPassword">
